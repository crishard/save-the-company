...
const steps = [
    ...
    <CardStepTwo title={stepsMissionTwo.titleCard2} text={stepsMissionTwo.textCard2} code={stepsMissionTwo.codigo} saida={stepsMissionTwo.saida} text2={''} text3={''} popover1Text={''} popover2Text={''} popover3Text={''} />,
