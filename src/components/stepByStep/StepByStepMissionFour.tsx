...
const StepByStepMissionFour = () => {
    ...
    return (
        <div>
            ...
            <div className='py-4'>
                {currentStep >= steps.length - 1 && <Link to='/fase4'>
